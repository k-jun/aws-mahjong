...
type RoomUsecase interface {
	Rooms() []*RoomStatus
	CreateRoom(userId string, userName string, roomName string, roomCapacity int) error
...
func (u *RoomUsecaseImpl) CreateRoom(userId string, userName string, roomName string, roomCapacity int) error {
